...
?>
<div class="animated infinite bounce" style="background-color:#F9F; width: 220px; padding:7px; border-radius:3px; color:#FFF; font-size:13px">Tiene <?php echo "<b><span style='color:#f03'>".$fila5["pedidos_nuevos"]."</span></b>"; ?> pedidos nuevos.
</div>
<?php
}
?>